...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h3 class="text-primary">Entrada de Inventario</h3>
    </div>
    <div class="col-md-7 align-self-center">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('entrada.index') }}">Entrada</a></li>
                        ...
                        <form method="POST" action="">
                            @csrf
                                ...
                                <div class="row pt-3">                                            
                                    ...
                                    <div class="col-md-3">
                                        <button type="button" id="btnadddet" class="btn btn-success" onclick="agregarDetalle()"><i class="fas fa-plus-circle"></i> Agregar</button>
                                    </div>        
                                    <div class="col-md-2">
