...
<div class="row page-titles">
    ...
    <div class="col-md-7 align-self-center">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('supplier.index') }}">Proveedor</a></li>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-7">
                                                <input type="text" id="representante" name="representante" class="form-control input-sm @error('representante') is-invalid @enderror">
                                                @error('representante')
                                                <div class="form-control-feedback" style="color:red">{{ $message }}</div>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="col-md-9">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-7">
                                                <input type="text" id="ruc" name="ruc" class="form-control input-sm @error('ruc') is-invalid @enderror">
                                                @error('ruc')
                                                <div class="form-control-feedback" style="color:red">{{ $message }}</div>
                                                @enderror
                                            </div>
