                ...
                <div class="card card-outline-info">
                    <form method="POST" action="{{ route('customer.update',$customer->id) }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-7">
                                                <input type="text" id="nombre" name="nombre" value="{{$customer->nombre}}" class="form-control input-sm @error('nombre') is-invalid @enderror">
                                                @error('nombre')
                                    ...
                                    <div class="col-md-9">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-7">
                                                <input type="text" id="direccion" name="direccion" value="{{$customer->direccion}}" class="form-control input-sm @error('direccion') is-invalid @enderror">
                                                @error('direccion')
                                                <div class="form-control-feedback" style="color:red">{{ $message }}</div>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="col-md-9">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-7">
                                                <input type="text" id="telefono" name="telefono" value="{{$customer->telefono}}" class="form-control input-sm @error('telefono') is-invalid @enderror">
                                                @error('telefono')
                                                <div class="form-control-feedback" style="color:red">{{ $message }}</div>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="col-md-9">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-7">
                                                <input type="text" id="email" name="email" value="{{$customer->email}}" class="form-control input-sm @error('email') is-invalid @enderror">
                                                @error('email')
                                                <div class="form-control-feedback" style="color:red">{{ $message }}</div>
                                                @enderror
                                            </div>
                        ...
                        <div class="offset-sm-5">
                            <a type="button" href="{{ route('cancelarCustomer') }}" class="btn btn-info btn">Cancelar</a>
