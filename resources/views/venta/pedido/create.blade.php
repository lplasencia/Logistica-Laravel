                            ...
                            <div class="form-body">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" id="tipo" name="tipo" value="{{$multitable[0]->porcentaje_impuesto}}" class="form-control" placeholder="Ingrese impuesto">
                                    </div>
                                    <div class="col-md-3">
                                        <label for="">Tipo Pedido : </label>
                                        <select name="pedido" id="pedido" class="form-select form-select-sm @error('pedido') is-invalid @enderror" aria-label=".form-select-sm example">
